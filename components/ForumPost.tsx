        ...
        /> */}
            ...
            <div className="w-0 flex-1 break-normal overflow-hidden">
              {!isProfile && (
                <div className="flex max-h-40 mt-1 space-x-2 text-xs">
                  ...
                  <div className=" flex space-x-2">
                    <span className=" mt-3 text-sm font-semibold dark:text-yellow-50 text-black">
                      {isAnonymous ? (
                        "Anonymous"
                      ) : (
                        <Link
                    ...
                    {isAnonymous || isCurrentUser || !user ? null : (
                      <div className=" flex space-x-1 mr-5 ">
                        ...
                        {
                          <button
                            className="text-xs mt-[0.33rem] text-[#1976d2] p-0 hover:underline cursor-pointer"
              ...
              <div className={`${post.title ? "" : "hidden"}`}>
                ...
                >
                  <h1
                    className={`font-bold font-dmsans py-2 leading-6 text-[17px] dark:text-white ${
