      ...
      <div className="container max-w-7xl h-full mx-auto flex items-center justify-between gap-2">
        ...
        <div className=" flex gap-[1.7rem]">
          <Link href="/" className="flex gap-2 items-center">
            <p className="hidden text-zinc-700 dark:text-emerald-100 text-sm font-medium md:block">
              Devotional-B
            </p>
          </Link>
          ...
          <Button variant="ghost" onClick={() => setClicked("ask")}>
            <SquarePen
              className={`w-5 h-5 ${clicked === 'ask' ? "text-red-500" : ""}`}
            />
          </Button>
